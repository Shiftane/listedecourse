...
// Default modules
var modules = ['ngCookies', 'ngResource', 'ui.bootstrap', 'ui.router', 'angularNumberPicker', 'ui.tree', 'angulartics','angulartics.google.tagmanager', 'mailchimp', 'ngRoute', 'ngClipboard'];
